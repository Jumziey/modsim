...
extern void pos_from_brown(int n, Vec* L, double noise, double alpha, double deltat, Vec* pos, Vec* force);
...
extern void measure(int n, Vec *L, Vec *pos, Vec *vel, double *epot, double *ekin);
